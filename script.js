...
// Dados iniciais
let produtos = [
    { id: 1, nome: "Salgado Mix", nomeAbreviado: "salg mix", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado: "null" },
    { id: 2, nome: "Doce Mix", nomeAbreviado: "doce mix", preco: 1.70, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 3, nome: "Coxinha", nomeAbreviado: "Coxinha", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado: "frito_promocional" },
    { id: 4, nome: "Risoles de carne", nomeAbreviado: "Risoles carne", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado: "frito_promocional" },
    ...
    { id: 6, nome: "Kibe", nomeAbreviado: "Kibe", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado: "frito_promocional" },
    { id: 7, nome: "Bolinha de queijo", nomeAbreviado: "B.queijo", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado:"frito_promocional" },
    { id: 8, nome: "Croquete de presunto e queijo", nomeAbreviado: "Balão", preco: 0.90, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado: "frito_promocional" },
    ...
    { id: 12, nome: "Bolinho de aipim c/ carne seca", nomeAbreviado: "B. aipim", preco: 1.20, descricao: "Salgado frito - valor por unidade", categoria: "Salgados", tipoSalgado:"frito_normal" },
    { id: 13, nome:"Mini churros de doce de leite", nomeAbreviado:"Churros frito", preco : 1.20, descricao:"Salgado frito - valor por unidade" , categoria:"Salgados" , tipoSalgado:"frito_normal"},
    { id: 14 ,nome: 'Doguinho assado',nomeAbreviado:'Doguinho',preco : 1.20,descricao:'Salgado assado - valor por unidade',categoria:'Salgados',tipoSalgado:'assado'},
    { id: 15 ,nome: 'Esfiha de carne',nomeAbreviado:'Esfiha carne',preco : 1.20,descricao:'Salgado assado - valor por unidade',categoria:'Salgados',tipoSalgado:'assado'},
    { id: 16 ,nome: 'Esfiha de frango',nomeAbreviado:'Esfiha frango',preco : 1.20,descricao:'Salgado assado - valor por unidade',categoria:'Salgados',tipoSalgado:'assado'},
    { id: 17 ,nome: 'Folhado de frango',nomeAbreviado:'Folh. frango',preco : 1.20,descricao:'Salgado assado - valor por unidade',categoria:'Salgados',tipoSalgado:'assado'},
    { id: 18, nome: "Folhado de palmito", nomeAbreviado: "Folh. palmito", preco: 1.20, descricao: "Salgado assado - valor por unidade", categoria: "Salgados", tipoSalgado: "assado" },
    { id: 19, nome: "Brigadeiro", nomeAbreviado: "Brigadeiro", preco: 1.60, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 20, nome: "Cajuzinho", nomeAbreviado: "Caju", preco: 1.60, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 21, nome: "Brigadeiro Branco", nomeAbreviado: "Brig. Branco", preco: 1.60, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 22, nome: "Beijinho", nomeAbreviado: "Beijinho", preco: 1.60, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 23, nome: "Dois Amores", nomeAbreviado: "2 Amores", preco: 1.60, descricao:"Doce - valor por unidade" , categoria:"Doces" , tipoSalgado:null},
    { id: 24 ,nome: 'Amendoim',nomeAbreviado:'Amendoim',preco : 1.60,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 25 ,nome: 'Bicho de pé',nomeAbreviado:'Bicho pé',preco : 1.60,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 26 ,nome: 'Brigadeiro de Churros',nomeAbreviado:'Brig. Churros',preco : 1.70,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 27 ,nome: 'Olho de Sogra',nomeAbreviado:'Olho Sogra',preco : 1.70,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    ...
    { id: 30, nome: "Mini donuts", nomeAbreviado: "Mini donuts", preco: 2.50, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 31, nome: "Mini brownie", nomeAbreviado: "Mini brownie", preco: 3.00, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 32, nome: "Oreo surprise", nomeAbreviado: "Oreo surprise", preco: 3.00, descricao: "Doce - valor por unidade", categoria: "Doces", tipoSalgado: null },
    { id: 33 ,nome: 'Ouriço de coco queimado',nomeAbreviado:'Ouriço',preco : 2.00,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 34 ,nome: 'Bombom Cereja',nomeAbreviado:'Bomb. Cereja',preco : 3.00,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 35 ,nome: 'Bombom Uva',nomeAbreviado:'Bomb. Uva',preco : 3.00,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 36 ,nome: 'Bombom de Morango',nomeAbreviado:'Bomb. Morango',preco : 4.00,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 37 ,nome: 'Brigadeiro Ferreiro',nomeAbreviado:'Ferreiro',preco : 2.10,descricao:'Doce - valor por unidade',categoria:'Doces',tipoSalgado:null},
    { id: 38, nome: "Caixa Doce Mix 42un", nomeAbreviado: "Cx Doce Mix 42un", preco: 70.00, descricao: "Caixa de doces - valor por caixa", categoria: "Doces", tipoSalgado: null },
    { id: 39, nome: "Caixa Doce Mix 100un", nomeAbreviado: "Cx Doce Mix 100un", preco: 170.00, descricao: "Caixa de doces - valor por caixa", categoria: "Doces", tipoSalgado: null },
    { id: 40, nome: "Bolo", nomeAbreviado: "Bolo", preco: 90.00, descricao: "Bolos", categoria: "Doces", tipoSalgado: null },
    { id: 41, nome: "Nega Maluca", nomeAbreviado: "Nega Maluca", preco: 40.00, descricao: "Bolos", categoria: "Doces", tipoSalgado: null },
    { id: 42, nome: "Bolo Cenoura", nomeAbreviado: "Bolo Cenoura", preco: 40.00, descricao: "Bolos", categoria: "Doces", tipoSalgado: null },
    { id: 43 ,nome: 'Morango do Amor',nomeAbreviado:'Morango Amor',preco : 10.00,descricao:'Morango do Amor❤️',categoria:'Doces',tipoSalgado:null},
    { id: 44 ,nome: 'Bandeja Morango do Amor',nomeAbreviado:'Bandeja Morango Amor',preco : 25.00,descricao:'5un Morango do Amor❤️',categoria:'Doces',tipoSalgado:null},
